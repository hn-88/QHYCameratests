...
int main(int argc,char *argv[])
{
    ...
    char camtype[16];
    int found = 0;
    unsigned int w,h,bpp,channels,capturenumber, cambitdepth=16, numofframes=10, firstaccum, secondaccum;
    ...
    if(found == 1)
    {
       ...
       ret = IsQHYCCDControlAvailable(camhandle,CONTROL_TRANSFERBIT);
        ...
        /////////////////////////////////////////
        /////////////////////////////////////////
        outfile<<"Gain,Exposure time (us),Camera,Number of frames averaged,Bit depth,Frame Mean1,Frame Mean2,Frame Std Dev1,Frame Std Dev2,mean of (Subtractedframe),std dev of (Subtractedframe),Avged Frame Mean1,Avged Frame Mean2,Avged Frame Std Dev1,Avged Frame Std Dev2,mean of (Avged Subtractedframe),std dev of (Avged Subtractedframe)"<<std::endl;
        
        for (camtime=1; camtime<10000;camtime=camtime+10)
        {
		firstaccum=numofframes;
		secondaccum=firstaccum;	
		doneflag = 0;
					...
					if (secondaccum==0)
								{
									...
									//outfile<<"Gain,Exposure time (us),Camera,Number of frames averaged,Bit depth,Frame Mean1,Frame Mean2,Frame Std Dev1,Frame Std Dev2,mean of (Subtractedframe),std dev of (Subtractedframe),Avged Frame Mean1,Avged Frame Mean2,Avged Frame Std Dev1,Avged Frame Std Dev2,mean of (Avged Subtractedframe),std dev of (Avged Subtractedframe)"<<std::endl;
									outfile<<camgain<<","<<camtime<<","<<id<<","<<numofframes<<","<<cambitdepth<<","<<meanframe1(0)<<","<<meanframe2(0)<<","<<stdframe1<<","<<stdframe2<<","<<meansubtracted(0)<<","<<stdsubtracted<<","<<meanavgframe1(0)<<","<<meanavgframe2(0)<<","<<stdavgframe1<<","<<stdavgframe2<<","<<meanavgsubtracted(0)<<","<<stdavgsubtracted<<std::endl;
